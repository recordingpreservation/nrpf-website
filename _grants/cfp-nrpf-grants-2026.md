---
title: "NRPF Grants: 2026 Call for Proposals"
date: 2026-06-22
layout: page
permalink: "/programs/grants/2026-call-for-proposals/"
...
Awards will be announced on or around September 30, 2026.
...
No. These grants are intended to supply resources that go directly toward preservation activities and do not support the general operating costs of an organization. [Please refer to NRPF's grant policies for more details]({% link _pages/grant-policies.md %}).
...
- [Call for Proposals (pdf version of this page)]({% link assets/files/2026-cfp-notice-v1.pdf %})
- [Application questions and instructions in pdf]({% link assets/files/2026-cfp-applyform-v1.pdf %}) - these may be used to preview the application questions and to prepare application materials
- [Budget Form Template](https://docs.google.com/document/d/1KoUXDIbBkbVS6f-5ooNnCPTExJgBDTgN/edit?usp=sharing&ouid=109744859461400605465&rtpof=true&sd=true) - available as a Google doc (click the "File" menu and then Download in your preferred format)
